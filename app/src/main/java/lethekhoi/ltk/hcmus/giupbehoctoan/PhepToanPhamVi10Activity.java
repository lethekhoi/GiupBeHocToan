...
public class PhepToanPhamVi10Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_phep_toan_pham_vi10);
    ...
    private void handleRandom() {
        ...
        switch (mIndex) {
            case 0://+
                ...
                mRandomSt2 = mRandom.nextInt(10 - mRandomSt1 + 1);
    ...
    private void event() {
        btnKiemTra.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(edtKetQua.getText().toString().equals(""))
                {
                    Toast.makeText(PhepToanPhamVi10Activity.this, "Hãy nhập kết quả", Toast.LENGTH_SHORT).show();
                    return;
                }
                else {
